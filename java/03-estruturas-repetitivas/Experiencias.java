...
public class Experiencias {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("Total de coelhos = " + rabbits_total);
	    System.out.println("Total de sapos = " +  frogs_total);
	    System.out.println("Total de ratos = " + rats_total);
	    System.out.println("Percentual de coelhos: " + String.format("%.2f", prab) + "%");
	    System.out.println("Percentual de ratos: " + String.format("%.2f", prat) + "%");
	    System.out.println("Percentual de sapos: " + String.format("%.2f", pf) + "%");
